...
import gproject.server.util.TimeUtil;
...
public class FlickrService {
    ...
    static private Token requestToken;
    ...
    public void init() {
        service = new ServiceBuilder()
                ...
                .apiKey(key)
                .apiSecret(secret)
                .callback(callback + "?user=" + SecurityContextHolder.getContext().getAuthentication().getName())
                .build();
    }
