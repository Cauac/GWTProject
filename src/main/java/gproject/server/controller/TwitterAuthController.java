...
import gproject.server.services.AuthServiceImpl;
...
public class TwitterAuthController {
    ...
    public ModelAndView getAccessToken(String oauth_token, String oauth_verifier, HttpServletRequest request) {
        ...
        OAuthToken token = oAuthOperations.exchangeForAccessToken(new AuthorizedRequestToken(authService.getRequestToken(), oauth_verifier), null);
